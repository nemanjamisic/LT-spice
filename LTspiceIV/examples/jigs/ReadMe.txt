...
circuit to use in any mass production.  In some instances,
the circuits are in fact bad circuits designed to show that
the macromodel handles some fault condition as the physical
device would.

They intended only to be a convenience to help to verify that
